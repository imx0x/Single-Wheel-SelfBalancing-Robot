...
double Kd = 2.4;  //2.2 or 2.4future  1.4 to 1.8  also try upto 2.2 //2.2//2.5//1.8//1.6 (P=1.8)
double Ki = 270;  // 270 Past    80  to 140  ; too good 160 //160 //170-180   (P=250)


PID pid(&input, &output, &setpoint, Kp, Ki, Kd, DIRECT);

double motorSpeedFactorLeft = 0.9;   //0.65
double motorSpeedFactorRight = 0.9;  //0.5
//MOTOR CONTROLLER
int ENA = 5;
int IN1 = 6;
int IN2 = 7;
...
// join I2C bus (I2Cdev library doesn't do this automatically)
  ...
  mpu.setZAccelOffset(1127);  // 1688 factory default for my test chip
...
void loop() {
  ...
  sensors_event_t a, g, temp;                         //servo code
